import { FileViewerAiOptions as CoreFileViewerAiOptions, FileViewerArchiveOptions as CoreFileViewerArchiveOptions, FileViewerBeforeOperation as CoreFileViewerBeforeOperation, FileViewerCadDwfLineWeightMode as CoreFileViewerCadDwfLineWeightMode, FileViewerCadOptions as CoreFileViewerCadOptions, FileViewerCadRenderer as CoreFileViewerCadRenderer, FileViewerComponentEmits as CoreFileViewerComponentEmits, FileViewerComponentEventMap as CoreFileViewerComponentEventMap, FileViewerComponentProps as CoreFileViewerComponentProps, FileViewerDocxOptions as CoreFileViewerDocxOptions, FileViewerDocumentAnchor as CoreFileViewerDocumentAnchor, FileViewerDocumentChunk as CoreFileViewerDocumentChunk, FileViewerFileRef, FileViewerLifecycleContext as CoreFileViewerLifecycleContext, FileViewerLifecycleHooks as CoreFileViewerLifecycleHooks, FileViewerLifecyclePhase as CoreFileViewerLifecyclePhase, FileViewerOperationAvailability as CoreFileViewerOperationAvailability, FileViewerOperationContext as CoreFileViewerOperationContext, FileViewerOperationType as CoreFileViewerOperationType, FileViewerOptions as CoreFileViewerOptions, FileViewerPdfOptions as CoreFileViewerPdfOptions, FileViewerSpreadsheetOptions as CoreFileViewerSpreadsheetOptions, FileViewerPublicApi as CoreFileViewerPublicApi, FileViewerRenderedInstance as CoreFileViewerRenderedInstance, FileRenderContext as CoreFileRenderContext, FileRenderExportAdapter as CoreFileRenderExportAdapter, FileRenderExportMode as CoreFileRenderExportMode, FileRenderExportOptions as CoreFileRenderExportOptions, FileRenderHandler, FileRenderHandlerComposite, FileViewerSearchMatch as CoreFileViewerSearchMatch, FileViewerSearchOptions as CoreFileViewerSearchOptions, FileViewerSearchProvider as CoreFileViewerSearchProvider, FileViewerSearchState as CoreFileViewerSearchState, FileViewerSourceKind as CoreFileViewerSourceKind, FileViewerThemeMode as CoreFileViewerThemeMode, FileViewerToolbarOptions as CoreFileViewerToolbarOptions, FileViewerToolbarPosition as CoreFileViewerToolbarPosition, FileViewerTypstOptions as CoreFileViewerTypstOptions, FileViewerApplyViewStateOptions as CoreFileViewerApplyViewStateOptions, FileViewerViewScrollState as CoreFileViewerViewScrollState, FileViewerViewState as CoreFileViewerViewState, FileViewerViewStateChange as CoreFileViewerViewStateChange, FileViewerViewStateChangeAction as CoreFileViewerViewStateChangeAction, FileViewerViewStateChangeSource as CoreFileViewerViewStateChangeSource, FileViewerViewStateProvider as CoreFileViewerViewStateProvider, FileViewerWatermarkOptions as CoreFileViewerWatermarkOptions, FileViewerZoomProvider as CoreFileViewerZoomProvider, FileViewerZoomState as CoreFileViewerZoomState } from '@file-viewer/core';
/**
 * 渲染器返回的可卸载包装实例。
 *
