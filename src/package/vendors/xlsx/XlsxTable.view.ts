...
const renderCellOverlay = (
  ...
  if (style.borderTop) {
    fragment.appendChild(createBorderLine('top', style.borderTop))
  }
  if (style.borderRight) {
    fragment.appendChild(createBorderLine('right', style.borderRight))
  }
  if (style.borderBottom) {
    fragment.appendChild(createBorderLine('bottom', style.borderBottom))
  }
  if (style.borderLeft) {
    fragment.appendChild(createBorderLine('left', style.borderLeft))
  }
