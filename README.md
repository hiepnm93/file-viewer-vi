...
当前版本以 npm registry 的 `latest` dist-tag 为准，共维护 29 个 npm 发布目标: 24 个标准组件/核心/renderer/preset/工程插件包 + 5 个历史兼容 alias。新项目建议优先使用 `@file-viewer/*` 标准包名；旧项目继续使用 `@flyfish-group/*` 或 `file-viewer3` 时也会拿到同版本能力。
...
| 全量 renderer preset                | [`@file-viewer/preset-all`](https://www.npmjs.com/package/@file-viewer/preset-all)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | 无                                                                                                                                                       | `latest` | 一次装配 PDF、OFD、CAD、Typst、XMind、压缩包、邮件、电子书、代码/Markdown、图片、音视频、PPTX 和 core 其余完整格式能力                                                   |
