...
export const buildExportHtmlDocument = ({ contentHtml, includeDocumentStyles = true, printStyle = '', title, watermarkInlineStyle = '' }) => {
...
export const buildFileViewerRenderedHtmlDocument = async ({ source, mode = 'export', title, adapter = null, watermarkInlineStyle = '' }) => {
