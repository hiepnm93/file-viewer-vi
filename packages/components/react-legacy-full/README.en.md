...
Full-format React 16.8/17 package. The release scripts replace this placeholder with the complete package README.
...
```bash
npm i @file-viewer/react-legacy-full @file-viewer/preset-office
```
...
```bash
npm i @file-viewer/react-legacy-full @file-viewer/preset-all
```
