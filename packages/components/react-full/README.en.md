...
Full-format React package. The release scripts replace this placeholder with the complete package README.
...
```bash
npm i @file-viewer/react-full @file-viewer/preset-office
```
...
```bash
npm i @file-viewer/react-full @file-viewer/preset-all
```
