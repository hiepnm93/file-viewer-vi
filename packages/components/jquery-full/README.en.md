...
Full-format jQuery package. The release scripts replace this placeholder with the complete package README.
...
```bash
npm i @file-viewer/jquery-full @file-viewer/preset-office
```
...
```bash
npm i @file-viewer/jquery-full @file-viewer/preset-all
```
