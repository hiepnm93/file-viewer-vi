...
当前 Vue3 npm 包是 `@flyfish-group/file-viewer3@1.0.19`。Vue3 构建产物也是 React、纯 JS 和 iframe 私有化方案的统一预览基线。
...
Vue2.7 项目请使用 `@flyfish-group/file-viewer@1.0.19`，插件注册方式是 `Vue.use(FileViewer)`。两条包线的文件格式能力、Demo 样例和 iframe 协议保持一致，详细步骤见 [Vue2 集成](/guide/quickstart-vue2)。
