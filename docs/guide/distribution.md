...
<p class="doc-lead">
  ...
  公开 GitHub 仓库只交付混淆压缩后的构建产物、示例文件、静态文档产物和下载包。
</p>
...
| npm 包(Vue3) | [@flyfish-group/file-viewer3](https://www.npmjs.com/package/@flyfish-group/file-viewer3) | Vue3 组件库，当前 latest 为 `1.0.8` |
| npm 包(Vue2) | [@flyfish-group/file-viewer](https://www.npmjs.com/package/@flyfish-group/file-viewer) | Vue2.7 组件库，当前 latest 为 `1.0.8` |
