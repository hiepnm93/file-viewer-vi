...
| npm 包(Vue3) | [@flyfish-group/file-viewer3](https://www.npmjs.com/package/@flyfish-group/file-viewer3) | Vue3 组件库，当前 latest 为 `1.0.12` |
| npm 包(Vue2) | [@flyfish-group/file-viewer](https://www.npmjs.com/package/@flyfish-group/file-viewer) | Vue2.7 组件库，当前 latest 为 `1.0.12` |
...
```bash
npm install ./artifacts/flyfish-group-file-viewer-web-1.0.12.tgz
npm install ./artifacts/flyfish-group-file-viewer-react-1.0.12.tgz
```
