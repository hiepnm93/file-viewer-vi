...
<div class="doc-grid">
  ...
  <div class="doc-card">
    <h3>多接入路线</h3>
    <p>Vue3、Vue2.7、Vue2.6、React 18/19、React 16.8/17、Pure Web、jQuery 和 Svelte 都有对应 npm 包；标准组件包复用同一套 core 能力，并提供各自生态的组件体验。</p>
  </div>
</div>
