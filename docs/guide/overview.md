...
| EDA | `@file-viewer/renderer-eda` 承接 OLB / DRA / GDSII / OASIS；GDSII 可生成 SVG 快速版图，OASIS / Cadence 高保真几何保留独立 WASM 内核路线 |
...
| 字体/设计/数据 | `@file-viewer/renderer-data` 承接字体、PSD、AI/EPS、SQLite、WASM、Parquet、Avro 和 WebArchive，以安全结构摘要和小样本预览为主 |
