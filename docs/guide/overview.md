...
<div class="doc-grid">
  <div class="doc-card">
    <h3>多格式预览</h3>
    <p>内置 63 个扩展名映射，覆盖 Word、Excel、PowerPoint、PDF、OFD、CAD、Excalidraw、draw.io、Markdown、图片、视频以及代码/文本。</p>
  </div>
  <div class="doc-card">
    <h3>纯前端渲染</h3>
...
- **格式策略务实。** OFD 基于 `DLTech21/ofd.js` 源码链路预览；CAD 支持 DXF，DWG 作为转换提示入口；Excalidraw 和 draw.io 使用官方预览能力；代码/日志使用 `highlight.js` 轻量高亮，HTML 按源码展示。内置 CAD、绘图和 UMD 回归样例来自公开仓库，方便复现实文件兼容问题。
