...
| React 17 / 18 / 19 | 当前仓库子工程 | `@flyfish-group/file-viewer-react` | `<FileViewer url="/files/demo.pdf" />` |
| 纯 JS | 当前仓库子工程 | `@flyfish-group/file-viewer-web` | `mountViewerFrame(container, options)` |
