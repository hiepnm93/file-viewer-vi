...
<p class="doc-lead">
  Vue2 包已经同步发布到 <code>@flyfish-group/file-viewer@1.0.19</code>。
...
| 版本 | npm 包 | 最新版本 | 注册方式 |
| --- | --- | --- | --- |
| Vue2.7 | `@flyfish-group/file-viewer` | `1.0.19` | `Vue.use(FileViewer)` |
| Vue3 | `@flyfish-group/file-viewer3` | `1.0.19` | `createApp(App).use(FileViewer)` |
