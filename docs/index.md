...
<span>安装 @flyfish-group/file-viewer3@1.0.19，使用 createApp(App).use(FileViewer)，样式会随安装器自动带入。</span>
</a>
<a class="doc-path-card" href="/guide/quickstart-vue2">
<strong>Vue2.7 项目</strong>
<span>安装 @flyfish-group/file-viewer@1.0.19，使用 Vue.use(FileViewer)，安装器会自动带上样式。</span>
</a>
<a class="doc-path-card" href="/guide/quickstart-react">
<strong>React 项目</strong>
<span>安装 @flyfish-group/file-viewer-react@1.0.19，通过 iframe 加载私有化 viewer。</span>
</a>
<a class="doc-path-card" href="/guide/quickstart-web">
<strong>纯 JS 页面</strong>
<span>安装 @flyfish-group/file-viewer-web@1.0.19，用 helper 创建和同步 iframe。</span>
</a>
