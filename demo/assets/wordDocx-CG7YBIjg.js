...
import{o as e}from"./chunk-CMxvf4Kt.js";import{d as t,l as n,p as r}from"./package-C4-u6O6i.js";import{o as i,s as a}from"./assets-DRyIZOP3.js";import{t as o}from"./preload-helper-kNaey6uv.js";import{i as s,n as c,r as l,t as u}from"./printLayout-C9NUCua_.js";var d={width:794,height:1123},f=2,p=12e4,m=.24,h=3,g=.15,_=9525,v=20555,y=(()=>{let e={module:null,async load(){return this.module||=o(()=>import(`./docx-preview-rR7HURBr.js`),__vite__mapDeps([0,1,2]),import.meta.url),this.module}};return async()=>await e.load()})(),b=e=>{if((e.byteLength>=4?new DataView(e).getUint16(0,!1):0)!==v)throw Error(`文件不是有效的 DOCX/OOXML 压缩包，可能下载不完整或被服务端错误内容替换，请重新上传或检查文件源。`)},x=(e,t,n)=>{let r=t?.options?.docx,o=e.ownerDocument.URL||void 0,s=r?.worker!==!1,c=r?.visualPagination===!0;return{debug:!1,experimental:!1,useWorker:s,workerUrl:s?a(r,o):void 0,workerJsZipUrl:s?i(r,o):void 0,workerFallback:!0,workerTimeout:r?.workerTimeout??p,renderPageBatchSize:r?.renderPageBatchSize??(r?.progressive===!1?2**53-1:f),renderYieldEveryMs:r?.renderYieldEveryMs??16,strictWordCompatibility:r?.strictWordCompatibility??!0,paginationTolerance:r?.paginationTolerance??2,breakPages:c,maxDynamicPaginationPasses:c?r?.maxDynamicPaginationPasses??1e3:0,awaitLayout:r?.awaitLayout??c,preserveComplexFieldResults:r?.preserveComplexFieldResults??!0,updatePageReferences:r?.updatePageReferences??!1,hideWebHiddenContent:r?.hideWebHiddenContent??!1,ignoreLastRenderedPageBreak:r?.ignoreLastRenderedPageBreak??!c,progress:e=>{(e.phase===`render`||e.phase===`layout`||e.phase===`done`)&&n()}}},S=e=>e.ownerDocument.defaultView,C=(e,t)=>{let n=S(t)?.HTMLElement;return n?e instanceof n:e instanceof HTMLElement},ee=e=>e?.options?.docx?.visualPagination===!0,w=`
.docx-fit-viewer {
