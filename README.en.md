...
The current version follows the npm registry `latest` dist-tag. The ecosystem publishes 29 npm targets: 24 standard component / core / renderer / preset / tooling packages and 5 historical aliases. New integrations should prefer the `@file-viewer/*` standard package names; existing applications using `@flyfish-group/*` or `file-viewer3` continue to receive the same versioned capability set.
...
| Full renderer preset                       | [`@file-viewer/preset-all`](https://www.npmjs.com/package/@file-viewer/preset-all)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | none                                                                                                                                                     | `latest`       | One-shot composition for PDF, OFD, CAD, Typst, XMind, archives, email, ebooks, code/Markdown, images, audio/video, PPTX, and the remaining complete core format matrix                                                       |
