...
| XMind mind maps                | `xmind`                                                                                                                                                                                                                                                                                                                        | `@ljheee/xmind-parser` parses XMind 8 XML and XMind 2020+ JSON packages; the browser renderer shows sheets, nodes, labels, notes, links, markers, images, outline, Pointer / mouse / touch drag-to-pan canvas, mobile pinch zoom, embedded WebView `buttons` compatibility, fit-to-view, zoom, search, print, and HTML export | Mind maps, planning boards, knowledge structures, meeting notes |
