...
| EDA                            | `olb`, `dra`, `gds`, `oas`, `oasis`                                                                                                                                                                                                                                                                                            | CFB-based OrCAD / Allegro inspection; standard GDSII records are parsed into an SVG layout preview with structures, boundaries, paths, text, and references; OAS/OASIS currently use safe structure indexing, readable strings, entity hints, and diagnostics | Component libraries, footprints, chip layout attachments        |
